...
</html>`,Je=new bt,mr=Object.assign({"/src/index.tsx":Oe});let yt=!1;for(const[,e]of Object.entries(mr))e&&(Je.route("/",e),Je.notFound(e.notFoundHandler),yt=!0);if(!yt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Je as default};

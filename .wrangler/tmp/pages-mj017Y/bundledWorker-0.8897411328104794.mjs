...
var At = /* @__PURE__ */ __name((e, t, r) => t in e ? kt(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r, "At");
var u = /* @__PURE__ */ __name((e, t, r) => At(e, typeof t != "symbol" ? t + "" : t, r), "u");
var He = /* @__PURE__ */ __name((e, t, r) => t.has(e) || Ue("Cannot " + r), "He");
var o = /* @__PURE__ */ __name((e, t, r) => (He(e, t, "read from private field"), r ? r.call(e) : t.get(e)), "o");
var x = /* @__PURE__ */ __name((e, t, r) => t.has(e) ? Ue("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), "x");
var p = /* @__PURE__ */ __name((e, t, r, s) => (He(e, t, "write to private field"), s ? s.call(e, r) : t.set(e, r), r), "p");
var m = /* @__PURE__ */ __name((e, t, r) => (He(e, t, "access private method"), r), "m");
var Ge = /* @__PURE__ */ __name((e, t, r, s) => ({ set _(a) {
  p(e, t, a, r);
}, get _() {
  return o(e, t, s);
} }), "Ge");
var Ke = /* @__PURE__ */ __name((e, t, r) => (s, a) => {
  let i = -1;
  return n(0);
  async function n(c) {
...
var at = /* @__PURE__ */ __name((e) => Le(e, decodeURI), "at");
...
var Fe = /* @__PURE__ */ __name((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? Le(e, lt) : e) : e, "Fe");
...
var It = ot;
var Ht = /* @__PURE__ */ __name((e, t) => ot(e, t, true), "Ht");
...
var ct = (Xe = class {
...
}, oe = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakSet(), dt = /* @__PURE__ */ __name(function(e) {
  const t = o(this, S)[0][this.routeIndex][1][e], r = m(this, $, Me).call(this, t);
  return r && /\%/.test(r) ? Ve(r) : r;
}, "dt"), ft = /* @__PURE__ */ __name(function() {
  ...
  return e;
}, "ft"), Me = /* @__PURE__ */ __name(function(e) {
  return o(this, S)[1] ? o(this, S)[1][e] : e;
}, "Me"), L = /* @__PURE__ */ new WeakMap(), Xe);
var Ft = { Stringify: 1 };
var ht = /* @__PURE__ */ __name(async (e, t, r, s, a) => {
...
var $e = /* @__PURE__ */ __name((e, t) => ({ "Content-Type": e, ...t }), "$e");
...
var Mt = (Qe = class {
  ...
  constructor(e, t) {
    ...
    u(this, "html", (e2, t2, r) => {
      const s = /* @__PURE__ */ __name((a) => m(this, B, ie).call(this, a, t2, $e("text/html; charset=UTF-8", r)), "s");
...
var Gt = (fe = class {
  ...
  route(t, r) {
    ...
    return r.routes.map((a) => {
      var n;
      let i;
      r.errorHandler === We ? i = a.handler : (i = /* @__PURE__ */ __name(async (c, l) => (await Ke([], r.errorHandler)(c, () => a.handler(c, l))).res, "i"), i[qt] = a.handler), m(n = s, E, V).call(n, a.method, a.path, i);
    }), this;
  }
  basePath(t) {
  ...
  mount(t, r, s) {
    let a, i;
    s && (typeof s == "function" ? i = s : (i = s.optionHandler, s.replaceRequest === false ? a = /* @__PURE__ */ __name((l) => l, "a") : a = s.replaceRequest));
    const n = i ? (l) => {
      const d = i(l);
...
}, P = /* @__PURE__ */ new WeakMap(), E = /* @__PURE__ */ new WeakSet(), gt = /* @__PURE__ */ __name(function() {
...
}, "gt"), T = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ __name(function(t, r, s) {
...
}, "V"), Ce = /* @__PURE__ */ __name(function(t, r) {
  if (t instanceof Error) return this.errorHandler(t, r);
  throw t;
}, "Ce"), Pe = /* @__PURE__ */ __name(function(t, r, s, a) {
...
var xt = [];
function Kt(e, t) {
  const r = this.buildAllMatchers(), s = /* @__PURE__ */ __name(((a, i) => {
...
}, q = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), ze = /* @__PURE__ */ new WeakSet(), vt = /* @__PURE__ */ __name(function(e) {
  const t = [];
  let r = e === y;
...
}, K = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), A = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakSet(), W = /* @__PURE__ */ __name(function(t, r, s, a, i) {
...
var pr = /* @__PURE__ */ __name((e) => async function(r, s) {
  return fr({ ...e, getContent: /* @__PURE__ */ __name(async (i) => hr(i, { manifest: e.manifest, namespace: e.namespace ? e.namespace : r.env ? r.env.__STATIC_CONTENT : void 0 }), "getContent") })(r, s);
}, "pr");
var ur = /* @__PURE__ */ __name((e) => pr(e), "ur");
...
var Oe = new bt();
Oe.use("/api/*", gr());
Oe.use("/*", ur({ root: "./public" }));
Oe.get("/api/sinistros", (e) => e.redirect("/sinistros_data.json"));
Oe.get("/", (e) => e.html(xr));
var xr = `<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
// ../.wrangler/tmp/bundle-vGC00T/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-vGC00T/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.8897411328104794.mjs.map
